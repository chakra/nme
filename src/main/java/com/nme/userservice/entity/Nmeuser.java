...
@Entity
@Table(name = "nmeuser")
public class Nmeuser implements UserDetails, Identifiable<Long> {
    private Long id;
    @Version
    Long version = 1L;
    @LastModifiedDate
    ...
    public Nmeuser(String username) {
        this();
    ...
    public boolean equals(Object obj) {
        if (obj == null || ! (obj instanceof Nmeuser)) {
            return false;
        }
        if (obj == this) {
            return true;
        }
        Nmeuser other = (Nmeuser) obj;
